public class AreaCalculator {
    ...
    public static double areaSquare(double side) {
        ...
        // this is one way to do it. The other functions have a more concise way -
        // instead of using else, return statement executes the method and returns the value
        // void keyword to specify to specify that a method should not have a return value
        } else { 
            Math.pow(side, 2);
        }
        return side;
